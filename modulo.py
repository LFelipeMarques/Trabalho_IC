    ...
    while opcao != 5:
        ...
        if opcao == 4:
            ...
            if len(conteudo) > 1000:
                print("Arquivo de conteudo possui mais de 1000 caracteres. Escolha outro arquivo de conteúdo.\n")
                continue
